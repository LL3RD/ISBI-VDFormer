...
class CocoDataset_5slices(CocoDataset):
    CLASSES = ('tumour',)
    ...
    def prepare_train_img(self, idx):
        ...
        results['img']._data = torch.stack(
            (result_data[0], result_data[1], results['img'].data, result_data[2], result_data[3]), 0)
        return results
    ...
    def prepare_test_img(self, idx):
        ...
        results['img'][0] = torch.stack(
            (result_data[0], result_data[1], results['img'][0].data, result_data[2], result_data[3]), 0).contiguous()
        return results
