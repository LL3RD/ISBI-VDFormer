...
class CocoDataset_9slices(CocoDataset):
    CLASSES = ('tumour',)
    ...
    def prepare_train_img(self, idx):
        ...
        results['img']._data = torch.stack(
            (result_data[0], result_data[1],result_data[2], result_data[3], results['img'].data, result_data[4],result_data[5], result_data[6],result_data[7], ), 0).contiguous()
        return results
    ...
    def prepare_test_img(self, idx):
        ...
        results['img'][0] = torch.stack(
            (result_data[0], result_data[1], result_data[2], result_data[3], results['img'][0].data, result_data[4], result_data[5], result_data[6], result_data[7]), 0).contiguous()
        return results
